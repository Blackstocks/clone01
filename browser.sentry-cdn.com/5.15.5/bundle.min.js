...
var Sentry = function(n) {
    ...
    ! function(n) {
    ...
    }(c || (c = {})), (a = n.Severity || (n.Severity = {})).Fatal = "fatal", a.Error = "error", a.Warning = "warning", a.Log = "log", a.Info = "info", a.Debug = "debug", a.Critical = "critical",
        function(n) {
        ...
        }(s || (s = {})), (f = n.Status || (n.Status = {})).Unknown = "unknown", f.Skipped = "skipped", f.Success = "success", f.RateLimit = "rate_limit", f.Invalid = "invalid", f.Failed = "failed",
        function(n) {
            n.fromHttpCode = function(t) {
    ...
    var v = function(n) {
        function t(t) {
            ...
            return e.message = t, e.name = r.prototype.constructor.name, h(e, r.prototype), e
        }
        return r(t, n), t
    }(Error);
    ...
    function _(n, t) {
        return !!y(n) && (r = t, "[object RegExp]" === Object.prototype.toString.call(r) ? t.test(n) : "string" == typeof t && -1 !== n.indexOf(t));
        var r
    }
    ...
    function C(n, t, r) {
        n.exception = n.exception || {}, n.exception.values = n.exception.values || [], n.exception.values[0] = n.exception.values[0] || {}, n.exception.values[0].value = n.exception.values[0].value || t || "", n.exception.values[0].type = n.exception.values[0].type || r || "Error"
    }

    function M(n, t) {
        void 0 === t && (t = {});
        try {
            n.exception.values[0].mechanism = n.exception.values[0].mechanism || {}, Object.keys(t).forEach(function(r) {
    ...
    function A(n) {
        try {
            for (var t = n, r = [], e = 0, i = 0, o = " > ".length, u = void 0; t && e++ < 5 && !("html" === (u = U(t)) || e > 1 && i + r.length * o + u.length >= 80);) r.push(u), i += u.length, t = t.parentNode;
    ...
    var q = Date.now(),
        ...
        P = function() {
            ...
            var n, t;
            return T().performance && void 0 === performance.timeOrigin && (performance.timeOrigin = performance.timing && performance.timing.navigationStart || q), T().performance || H
        }();
    ...
    var V, K = G.__SENTRY__.logger || (G.__SENTRY__.logger = new z),
        Q = function() {
            function n() {
    ...
    function en(n, t, r, e) {
        if (void 0 === r && (r = 1 / 0), void 0 === e && (e = new Q), 0 === r) return function(n) {
        ...
        for (var c in o) Object.prototype.hasOwnProperty.call(o, c) && (u[c] = en(c, o[c], r - 1, e));
    ...
    var cn = function() {
            function n(n) {
                var t = this;
                this.s = V.PENDING, this.h = [], this.v = function(n) {
                    t.l(V.RESOLVED, n)
                }, this.p = function(n) {
                    t.l(V.REJECTED, n)
                }, this.l = function(n, r) {
                    t.s === V.PENDING && (E(r) ? r.then(t.v, t.p) : (t.s = n, t.m = r, t.g()))
                }, this.j = function(n) {
                    t.h = t.h.concat(n), t.g()
                }, this.g = function() {
                    if (t.s !== V.PENDING) {
                        var n = t.h.slice();
                        t.h = [], n.forEach(function(n) {
                            n.done || (t.s === V.RESOLVED && n.onfulfilled && n.onfulfilled(t.m), t.s === V.REJECTED && n.onrejected && n.onrejected(t.m), n.done = !0)
                        })
                    }
                };
                try {
        ...
        if (!pn[n]) switch (pn[n] = !0, n) {
            ...
            case "dom":
                ! function() {
                    ...
                    ln.document.addEventListener("click", _n("click", bn.bind(null, "dom")), !1), ln.document.addEventListener("keypress", Sn(bn.bind(null, "dom")), !1), ["EventTarget", "Node"].forEach(function(n) {
                        ...
                        t && t.hasOwnProperty && t.hasOwnProperty("addEventListener") && (Y(t, "addEventListener", function(n) {
                            return function(t, r, e) {
                                return r && r.handleEvent ? ("click" === t && Y(r, "handleEvent", function(n) {
                                    return function(t) {
                                        return _n("click", bn.bind(null, "dom"))(t), n.call(this, t)
                                    }
                                }), "keypress" === t && Y(r, "handleEvent", function(n) {
                                    return function(t) {
                                        return Sn(bn.bind(null, "dom"))(t), n.call(this, t)
                                    }
                                })) : ("click" === t && _n("click", bn.bind(null, "dom"), !0)(this), "keypress" === t && Sn(bn.bind(null, "dom"))(this)), n.call(this, t, r, e)
                            }
                    ...
                    Y(n, "open", function(n) {
                        return function() {
                            ...
                            return this.__sentry_xhr__ = {
                                ...
                                url: t[1]
                            }, y(e) && "POST" === this.__sentry_xhr__.method && e.match(/sentry_key/) && (this.__sentry_own_request__ = !0), n.apply(this, t)
                        }
                    }), Y(n, "send", function(n) {
                        return function() {
                            for (var t = [], r = 0; r < arguments.length; r++) t[r] = arguments[r];
                            ...
                            return bn("xhr", e({}, o)), i.addEventListener("readystatechange", function() {
                                if (4 === i.readyState) {
                                    try {
                ...
                ! function() {
                    ...
                    Y(ln, "fetch", function(n) {
                        return function() {
                            ...
                            return bn("fetch", e({}, i)), n.apply(ln, t).then(function(n) {
                                return bn("fetch", e({}, i, {
                                    endTimestamp: Date.now(),
                                    response: n
                                })), n
            ...
            case "history":
                ! function() {
                    if (n = T(), t = n.chrome, r = t && t.app && t.app.runtime, e = "history" in n && !!n.history.pushState && !!n.history.replaceState, r || !e) return;
                    var n, t, r, e;
                    var i = ln.onpopstate;
                    ...
                    }, Y(ln.history, "pushState", o), Y(ln.history, "replaceState", o)
                }();
                break;
            case "error":
                On = ln.onerror, ln.onerror = function(n, t, r, e, i) {
                    return bn("error", {
                        column: e,
                        error: i,
                        line: r,
            ...
            case "unhandledrejection":
                Tn = ln.onunhandledrejection, ln.onunhandledrejection = function(n) {
                    return bn("unhandledrejection", n), !Tn || Tn.apply(this, arguments)
                };
                break;
            default:
    ...
    function mn(n) {
        n && "string" == typeof n.type && "function" == typeof n.callback && (dn[n.type] = dn[n.type] || [], dn[n.type].push(n.callback), yn(n.type))
    }
    ...
    function wn(n) {
        return void 0 === n && (n = []), "Request" in ln && x(n[0], Request) && n[0].method ? String(n[0].method).toUpperCase() : n[1] && n[1].method ? String(n[1].method).toUpperCase() : "GET"
    }

    function gn(n) {
        return void 0 === n && (n = []), "string" == typeof n[0] ? n[0] : "Request" in ln && x(n[0], Request) ? n[0].url : String(n[0])
    }
    var En, xn, jn = 1e3,
        kn = 0;
    ...
    function _n(n, t, r) {
        return void 0 === r && (r = !1),
            function(e) {
                En = void 0, e && xn !== e && (xn = e, kn && clearTimeout(kn), r ? kn = setTimeout(function() {
                    t({
                        event: e,
                        name: n
                    })
    ...
    function Sn(n) {
        return function(t) {
            ...
            var e = r && r.tagName;
            e && ("INPUT" === e || "TEXTAREA" === e || r.isContentEditable) && (En || _n("input", n)(t), clearTimeout(En), En = setTimeout(function() {
                En = void 0
            }, jn))
        }
    }
    ...
    var Dn = /^(?:(\w+):)\/\/(?:(\w+)(?::(\w+))?@)([\w\.-]+)(?::(\d+))?\/(.+)/,
        Rn = function() {
            function n(n) {
                "string" == typeof n ? this.S(n) : this.O(n), this.T()
            }
            return n.prototype.toString = function(n) {
                ...
                var r = o(t.slice(1), 6),
                    ...
                    l = r[5],
                    d = l.split("/");
                d.length > 1 && (h = d.slice(0, -1).join("/"), l = d.pop()), this.O({
                    host: a,
                    pass: c,
                    path: h,
                    projectId: l,
        ...
        Nn = function() {
            function n() {
                this.D = !1, this.R = [], this.N = [], this.I = [], this.C = {}, this.M = {}, this.A = {}, this.U = {}
            }
            return n.prototype.addScopeListener = function(n) {
                ...
                var o = this;
                return void 0 === i && (i = 0), new cn(function(u, c) {
                    var a = n[i];
                ...
                return this.C = n || {}, this.q(), this
            }, n.prototype.setTags = function(n) {
                return this.M = e({}, this.M, n), this.q(), this
            }, n.prototype.setTag = function(n, t) {
                var r;
                return this.M = e({}, this.M, ((r = {})[n] = t, r)), this.q(), this
            }, n.prototype.setExtras = function(n) {
                return this.A = e({}, this.A, n), this.q(), this
            }, n.prototype.setExtra = function(n, t) {
                var r;
                return this.A = e({}, this.A, ((r = {})[n] = t, r)), this.q(), this
            }, n.prototype.setFingerprint = function(n) {
                return this.H = n, this.q(), this
            }, n.prototype.setLevel = function(n) {
                return this.P = n, this.q(), this
            }, n.prototype.setTransaction = function(n) {
                return this.F = n, this.W && (this.W.transaction = n), this.q(), this
            }, n.prototype.setContext = function(n, t) {
                var r;
                return this.U = e({}, this.U, ((r = {})[n] = t, r)), this.q(), this
                ...
                var r = new n;
                return t && (r.I = u(t.I), r.M = e({}, t.M), r.A = e({}, t.A), r.U = e({}, t.U), r.C = t.C, r.P = t.P, r.W = t.W, r.F = t.F, r.H = t.H, r.N = u(t.N)), r
            }, n.prototype.clear = function() {
                return this.I = [], this.M = {}, this.A = {}, this.C = {}, this.U = {}, this.P = void 0, this.F = void 0, this.H = void 0, this.W = void 0, this.q(), this
            }, n.prototype.addBreadcrumb = function(n, t) {
                var r = e({
                    timestamp: F()
                }, n);
                return this.I = void 0 !== t && t >= 0 ? u(this.I, [r]).slice(-t) : u(this.I, [r]), this.q(), this
            }, n.prototype.clearBreadcrumbs = function() {
                return this.I = [], this.q(), this
            }, n.prototype.X = function(n) {
                n.fingerprint = n.fingerprint ? Array.isArray(n.fingerprint) ? n.fingerprint : [n.fingerprint] : [], this.H && (n.fingerprint = n.fingerprint.concat(this.H)), n.fingerprint && !n.fingerprint.length && delete n.fingerprint
            }, n.prototype.applyToEvent = function(n, t) {
                return this.A && Object.keys(this.A).length && (n.extra = e({}, this.A, n.extra)), this.M && Object.keys(this.M).length && (n.tags = e({}, this.M, n.tags)), this.C && Object.keys(this.C).length && (n.user = e({}, this.C, n.user)), this.U && Object.keys(this.U).length && (n.contexts = e({}, this.U, n.contexts)), this.P && (n.level = this.P), this.F && (n.transaction = this.F), this.W && (n.contexts = e({
                    trace: this.W.getTraceContext()
                }, n.contexts)), this.X(n), n.breadcrumbs = u(n.breadcrumbs || [], this.I), n.breadcrumbs = n.breadcrumbs.length > 0 ? n.breadcrumbs : void 0, this.L(u(In(), this.N), n, t)
            }, n
        }();
    ...
    var Mn = 3,
        An = function() {
            function n(n, t, r) {
                void 0 === t && (t = new Nn), void 0 === r && (r = Mn), this.B = r, this.$ = [], this.$.push({
                    client: n,
                    scope: t
                })
            }
            return n.prototype.G = function(n) {
                ...
                this.getStackTop().client = n, n && n.setupIntegrations && n.setupIntegrations()
    ...
    function Ln() {
        var n = Un();
        return Hn(n) && !Pn(n).isOlderThan(Mn) || Fn(n, new An), S() ? function(n) {
            try {
                var t = Un(),
                    r = t.__SENTRY__;
                if (!r || !r.extensions || !r.extensions.domain) return Pn(n);
    ...
    function Pn(n) {
        return n && n.__SENTRY__ && n.__SENTRY__.hub ? n.__SENTRY__.hub : (n.__SENTRY__ = n.__SENTRY__ || {}, n.__SENTRY__.hub = new An, n.__SENTRY__.hub)
    }
    ...
    var Bn = function() {
            ...
            return n.prototype.getDsn = function() {
                ...
                return e.push("sentry_client=" + n + "/" + t), e.push("sentry_key=" + r.user), r.pass && e.push("sentry_secret=" + r.pass), {
    ...
    function Gn(n) {
        ...
        return function(n) {
            ...
            t[n.name] = n,
                function(n) {
                    -1 === $n.indexOf(n.name) && (n.setupOnce(Cn, Ln), $n.push(n.name), K.log("Integration installed: " + n.name))
                }(n)
        }), t
    }
    var Jn, zn = function() {
            function n(n, t) {
                this.Z = {}, this.nn = !1, this.tn = new n(t), this.rn = t, t.dsn && (this.en = new Rn(t.dsn))
            }
            return n.prototype.captureException = function(n, t, r) {
                var e = this,
                    i = t && t.event_id;
                return this.nn = !0, this.in().eventFromException(n, t).then(function(n) {
                    return e.on(n, t, r)
                }).then(function(n) {
                    i = n && n.event_id, e.nn = !1
                ...
                var i = this,
                    o = r && r.event_id;
                return this.nn = !0, (m(n) ? this.in().eventFromMessage("" + n, t, r) : this.in().eventFromException(n, r)).then(function(n) {
                    return i.on(n, r, e)
                }).then(function(n) {
                    o = n && n.event_id, i.nn = !1
                }).then(null, function(n) {
                    K.error(n), i.nn = !1
                }), o
                ...
                var e = this,
                    i = t && t.event_id;
                return this.nn = !0, this.on(n, t, r).then(function(n) {
                    i = n && n.event_id, e.nn = !1
                }).then(null, function(n) {
                    K.error(n), e.nn = !1
                }), i
                ...
                return this.un(n).then(function(r) {
                    return clearInterval(r.interval), t.in().getTransport().close(n).then(function(n) {
                        return r.ready && n
                    })
                })
                ...
                var i = this,
                    ...
                    v = void 0 === h ? 3 : h,
                    l = e({}, n);
                void 0 === l.environment && void 0 !== u && (l.environment = u), void 0 === l.release && void 0 !== c && (l.release = c), void 0 === l.dist && void 0 !== a && (l.dist = a), l.message && (l.message = j(l.message, f));
                var d = l.exception && l.exception.values && l.exception.values[0];
                d && d.value && (d.value = j(d.value, f));
                var p = l.request;
                p && p.url && (p.url = j(p.url, f)), void 0 === l.event_id && (l.event_id = r && r.event_id ? r.event_id : D()), this.sn(l.sdk);
                var y = cn.resolve(l);
                return t && (y = t.applyToEvent(l, r)), y.then(function(n) {
                ...
                return this.cn() ? "number" == typeof u && Math.random() > u ? cn.reject("This event has been sampled, will not send event.") : new cn(function(i, u) {
                    e.an(n, r, t).then(function(n) {
                        if (null !== n) {
                            var r = n;
                            if (t && t.data && !0 === t.data.__sentry__ || !o) return e.in().sendEvent(r), void i(r);
                            var c = o(n, t);
        ...
        Kn = function() {
            function n(n) {
                this.rn = n, this.rn.dsn || K.warn("No DSN provided, backend will not do anything."), this.vn = this.ln()
            }
    ...
    var Qn = function() {
            ...
            return n.prototype.setupOnce = function() {
                Jn = Function.prototype.toString, Function.prototype.toString = function() {
                    for (var n = [], t = 0; t < arguments.length; t++) n[t] = arguments[t];
        ...
        Zn = function() {
            function n(t) {
                void 0 === t && (t = {}), this.rn = t, this.name = n.id
            }
            return n.prototype.setupOnce = function() {
                Cn(function(t) {
                    var r = Ln();
            ...
            if (t = function(n) {
                    ...
                    for (var t, r = n.stacktrace, e = / line (\d+).*script (?:in )?(\S+)(?:: in function (\S+))?$/i, i = / line (\d+), column (\d+)\s*(?:in (?:<anonymous function: ([^>]+)>|([^\)]+))\((.*)\))? in (.*):\s*$/i, o = r.split("\n"), u = [], c = 0; c < o.length; c += 2) {
                        ...
                        (t = e.exec(o[c])) ? a = {
                            ...
                            line: +t[1],
                            column: +t[2]
                        }), a && (!a.func && a.line && (a.func = tt), u.push(a))
                    }
            ...
            if (t = function(n) {
                    ...
                    for (var t, r, e, i = [], o = n.stack.split("\n"), u = 0; u < o.length; ++u) {
                        if (r = rt.exec(o[u])) {
                            ...
                            r[2] && 0 === r[2].indexOf("eval") && (t = ut.exec(r[2])) && (r[2] = t[1], r[3] = t[2], r[4] = t[3]), e = {
                            ...
                            if (!(r = et.exec(o[u]))) continue;
                            r[3] && r[3].indexOf(" > eval") > -1 && (t = ot.exec(r[3])) ? (r[1] = r[1] || "eval", r[3] = t[1], r[4] = t[2], r[5] = "") : 0 !== u || r[5] || void 0 === n.columnNumber || (i[0].column = n.columnNumber + 1), e = {
                                url: r[3],
                                func: r[1] || tt,
                                args: r[2] ? r[2].split(",") : [],
                                line: r[4] ? +r[4] : null,
    ...
    function lt(n) {
        ...
        var t = n,
            r = t[0].func || "",
            e = t[t.length - 1].func || "";
        return -1 === r.indexOf("captureMessage") && -1 === r.indexOf("captureException") || (t = t.slice(1)), -1 !== e.indexOf("sentryWrapped") && (t = t.slice(0, -1)), t.map(function(n) {
            return {
    ...
    function dt(n, t, r) {
        var e, i;
        if (void 0 === r && (r = {}), d(n) && n.error) return e = vt(ct(n = n.error));
    ...
    var yt = function() {
            function n(n) {
                this.options = n, this._ = new an(30), this.url = new Bn(this.options.dsn).getStoreEndpointWithUrlEncodedAuth()
            }
        ...
        bt = function(t) {
            function e() {
                ...
                return n.xn = new Date(Date.now()), n
            }
            return r(e, t), e.prototype.sendEvent = function(t) {
                ...
                return void 0 !== this.options.headers && (e.headers = this.options.headers), this._.add(new cn(function(t, i) {
        ...
        Et = function(t) {
            ...
            return r(i, t), i.prototype.ln = function() {
                ...
                return M(e, {
                    handled: !0,
                    type: "generic"
                }), e.level = n.Severity.Error, r && r.event_id && (e.event_id = r.event_id), cn.resolve(e)
            }, i.prototype.eventFromMessage = function(t, r, e) {
                void 0 === r && (r = n.Severity.Info);
                var i = pt(t, e && e.syntheticException || void 0, {
                    attachStacktrace: this.rn.attachStacktrace
                });
                return i.level = r, e && e.event_id && (i.event_id = e.event_id), cn.resolve(i)
            }, i
        }(Kn),
        xt = "sentry.javascript.browser",
        jt = function(n) {
            function t(t) {
                return void 0 === t && (t = {}), n.call(this, Et, t) || this
            }
            return r(t, n), t.prototype.an = function(t, r, i) {
                return t.platform = t.platform || "javascript", t.sdk = e({}, t.sdk, {
                    name: xt,
    ...
    function St(n, t, r) {
        ...
        var sentryWrapped = function() {
            ...
            try {
                ...
                throw kt += 1, setTimeout(function() {
                    kt -= 1
                }), Xn(function(r) {
                    r.addEventProcessor(function(n) {
                        var r = e({}, n);
                        return t.mechanism && (C(r, void 0, void 0), M(r, t.mechanism)), r.extra = e({}, r.extra, {
                            arguments: i
                        }), r
                    }), captureException(n)
                }), n
    ...
    var Ot = function() {
            function t(n) {
                this.name = t.id, this.jn = !1, this.kn = !1, this.rn = e({
                    onerror: !0,
                    onunhandledrejection: !0
                }, n)
            }
            return t.prototype.setupOnce = function() {
                Error.stackTraceLimit = 50, this.rn.onerror && (K.log("Global Handler attached: onerror"), this._n()), this.rn.onunhandledrejection && (K.log("Global Handler attached: onunhandledrejection"), this.Sn())
                ...
                n.exception = n.exception || {}, n.exception.values = n.exception.values || [], n.exception.values[0] = n.exception.values[0] || {}, n.exception.values[0].stacktrace = n.exception.values[0].stacktrace || {}, n.exception.values[0].stacktrace.frames = n.exception.values[0].stacktrace.frames || [];
                ...
                return function() {
                    ...
                    return ["onload", "onerror", "onprogress", "onreadystatechange"].forEach(function(n) {
                        n in e && "function" == typeof e[n] && Y(e, n, function(t) {
                            ...
                            return t.__sentry_original__ && (r.mechanism.data.handler = $(t.__sentry_original__)), St(t, r)
                        })
                    }), n.apply(this, t)
                }
        ...
        Dt = function() {
            ...
            return t.prototype.An = function(t) {
                ...
                } else this.rn.sentry && n.xhr.__sentry_own_request__ && Rt(n.args[0])
                ...
                if (t.endTimestamp) {
                    ...
                    if (this.rn.sentry && i) {
                        ...
                        if (o && -1 !== t.fetchData.url.indexOf(o) && "POST" === t.fetchData.method && t.args[1] && t.args[1].body) return void Rt(t.args[1].body)
                    }
                ...
                var t = T(),
                    ...
                    o = R(r),
                    u = R(e);
                o.path || (o = i), i.protocol === u.protocol && i.host === u.host && (e = u.relative), i.protocol === o.protocol && i.host === o.host && (r = o.relative), Ln().addBreadcrumb({
                    category: "navigation",
                    data: {
                        from: r,
                        to: e
    ...
    var Nt = "cause",
        ...
        Ct = function() {
            function n(t) {
                void 0 === t && (t = {}), this.name = n.id, this.Pn = t.key || Nt, this.k = t.limit || It
            }
            return n.prototype.setupOnce = function() {
                Cn(function(t, r) {
                ...
                return n.exception.values = u(r, n.exception.values), n
            ...
            return n.prototype.setupOnce = function() {
                Cn(function(t) {
                    if (Ln().getIntegration(n)) {
                        if (!Mt.navigator || !Mt.location) return t;
                        var r = t.request || {};
                        return r.url = r.url || Mt.location.href, r.headers = r.headers || {}, r.headers["User-Agent"] = Mt.navigator.userAgent, e({}, t, {
                            request: r
                        })
                    }
                    return t
    ...
    var Pt = e({}, Lt, nt, Ut);
    return n.BrowserClient = jt, n.Hub = An, n.Integrations = Pt, n.SDK_NAME = xt, n.SDK_VERSION = "5.15.5", n.Scope = Nn, n.Transports = gt, n.addBreadcrumb = function(n) {
        Wn("addBreadcrumb", n)
    }, n.addGlobalEventProcessor = Cn, n.captureEvent = function(n) {
        ...
        Wn("configureScope", n)
    }, n.defaultIntegrations = qt, n.flush = function(n) {
        var t = Ln().getClient();
        return t ? t.flush(n) : cn.reject(!1)
    }, n.forceLoad = function() {}, n.getCurrentHub = Ln, n.getHubFromCarrier = Pn, n.init = function(n) {
        if (void 0 === n && (n = {}), void 0 === n.defaultIntegrations && (n.defaultIntegrations = qt), void 0 === n.release) {
            var t = T();
        ...
        void 0 === n && (n = {}), n.eventId || (n.eventId = Ln().lastEventId());
        var t = Ln().getClient();
        t && t.showReportDialog(n)
    }, n.withScope = Xn, n.wrap = function(n) {
        return St(n)()
    }, n
}({});
